...
public class Publish {
	...
	public void publishBusiness(UDDIClerk clerk) {
		...
		myBusEntity.setBusinessKey("uddi:uddi.mypublisher.com:business_WSDL-Business");
	...
	private void setupPublisher(UDDIClerk clerk) throws DispositionReportFaultMessage, RemoteException, ConfigurationException, TransportException {
		...
		p.setAuthorizedName("mypublisher");
		...
		keyGenerator.setTModelKey("uddi:uddi.mypublisher.com:keygenerator");
		Name name = new Name();
