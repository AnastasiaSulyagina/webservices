...
public class Find {
	...
	public void find() {
		try {
			...
			System.out.println("Do a find business using the businessKey uddi:uddi.mypublisher.com:business_wsdl-business");
        	BusinessEntity businessEntity = clerk.findBusiness("uddi:uddi.mypublisher.com:business_wsdl-business");
        	//
